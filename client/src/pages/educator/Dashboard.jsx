     ...
     md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          <div className='flex flex-1 min-w-[14rem] items-center gap-3 border border-blue-500 p-4 rounded-md'>
      ...
      <div>
        <h2 className='pb-4 text-lg font-medium'>Latest Enrollmnets</h2>
