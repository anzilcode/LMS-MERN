  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start
        ...
        <div className='absolute top-0 left-0 w-full z-1 bg-gradient-to-b from-cyan-100/70 h-[500px]'>
        </div>
        {/* left column */}
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            ...
            <p className='text-sm'>Course by <span className='text-blue-600 underline'>Anzil Hussain</span></p>
                    ...
                    <div className='border border-gray-300 bg-white mb-2 rounded' key={index}>
                      ...
                      <div className={`overflow-hidden transition-all duration-300
                       ${openSection[index] ? 'max-h-96' : 'max-h-0'}`}>                      
                        ...
                        border-t border-gray-300'>{chapter.chapterContent.map((lecture,index)=>{
                          return <li className='flex items-start gap-2 py-1' key={index}>
                            {<img className='w-4 h-4 mt-1' src={assets.play_icon} alt='playIcon'/>}
        ...
        {/* Right column */}
        <div className='z-10 w-[424px] rounded-t md:rounded-none shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)]
          ...
          <div className='p-5'>
            ...
            <div className='flex gap-3 items-center pt-2'>
              <p className='ext-gray-800 md:text-4xl text-2xl font-semibold'>{currency}{(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100).toFixed(2)}</p>
            ...
            {isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
             ...
             <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                ...
                <li>Step by step, hands-on project guidance with free updates</li>
